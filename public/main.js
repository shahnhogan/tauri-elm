// elm-watch hot {"version":"1.1.0","targetName":"app","webSocketPort":57348}
"use strict";
(() => {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('A delightful language for reliable web applications.')
					])),
				A2(
				$elm$html$Html$img,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src('assets/elm-logo.png'),
						$elm$html$Html$Attributes$height(256),
						$elm$html$Html$Attributes$width(256),
						$elm$html$Html$Attributes$alt('Elm language logo')
					]),
				_List_Nil)
			]));
};
